...
# # UAT
# #
# module "UAT-CSTAR-MIL-TLS-CERT-SERVICE-CONN-FEDERATED" {
#
#   providers = {
#     azurerm = azurerm.uat
#   }
...
# }
#
# resource "azurerm_key_vault_access_policy" "UAT-CSTAR-MIL-TLS-CERT-SERVICE-CONN_kv_access_policy" {
#   provider     = azurerm.uat
#   key_vault_id = data.azurerm_key_vault.domain_kv_uat.id
#   tenant_id    = data.azurerm_client_config.current.tenant_id
#   object_id    = module.UAT-CSTAR-MIL-TLS-CERT-SERVICE-CONN-FEDERATED.service_principal_object_id
#
#   certificate_permissions = ["Get", "Import"]
# }
#
