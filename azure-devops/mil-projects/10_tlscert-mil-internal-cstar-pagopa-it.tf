...
locals {
  tlscert-mil-internal-cstar-pagopa-it = {
    ...
    service_connection_ids_authorization = [
      module.prod_cstar_mil_tls_cert_service_conn_federated.service_endpoint_id,
    ]
  }
  tlscert-mil-internal-cstar-pagopa-it-variables = {
    KEY_VAULT_SERVICE_CONNECTION = module.prod_cstar_mil_tls_cert_service_conn_federated.service_endpoint_name,
