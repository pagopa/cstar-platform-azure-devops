...
locals {
  ...
  dev_backoffice_api_base_url    = "https://api-emd.dev.cstar.pagopa.it/emd/backoffice"
  dev_backoffice_ar_base_url     = "https://dev.selfcare.pagopa.it"
  dev_assistance_email           = module.domain_dev_secrets.values["email-mdc-google"].value
  ...
  uat_backoffice_api_base_url    = "https://api-emd.uat.cstar.pagopa.it/emd/backoffice"
  uat_backoffice_ar_base_url     = "https://uat.selfcare.pagopa.it"
  uat_assistance_email           = module.domain_uat_secrets.values["email-mdc-google"].value
  ...
  prod_backoffice_api_base_url    = "https://api-emd.cstar.pagopa.it/emd/backoffice"
  prod_backoffice_ar_base_url     = "https://selfcare.pagopa.it"
  prod_assistance_email           = module.domain_prod_secrets.values["email-mdc-google"].value
  ...
  emd_ar_backoffice_fe_variables_deploy = {
    ...
    DEV_MDC_ASSISTANCE_MAIL = local.dev_assistance_email
    ...
    UAT_MDC_ASSISTANCE_MAIL = local.uat_assistance_email
    ...
    PROD_MDC_ASSISTANCE_MAIL = local.prod_assistance_email
  }
}
