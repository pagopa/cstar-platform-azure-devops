locals {
  ...
  certificates = {
    # mdc.itn.internl.cstar.pagopa.it
    mdc-itn-internal-dev-cstar-pagopa-it : {
      env              = "dev"
      dns_record_name  = "mdc.itn.internal"
      variables        = {}
      variables_secret = {}
    }
    mdc-itn-internal-uat-cstar-pagopa-it : {
      env              = "uat"
      dns_record_name  = "mdc.itn.internal"
      variables        = {}
      variables_secret = {}
    }
    mdc-itn-internal-cstar-pagopa-it : {
      env              = "prod"
      dns_record_name  = "mdc.itn.internal"
      variables        = {}
      variables_secret = {}
