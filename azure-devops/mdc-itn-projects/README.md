...
| <a name="module_emd_ar_backoffice_admin_fe_deploy"></a> [emd\_ar\_backoffice\_admin\_fe\_deploy](#module\_emd\_ar\_backoffice\_admin\_fe\_deploy) | ./.terraform/modules/__devops_v0__/azuredevops_build_definition_generic | n/a |
| <a name="module_emd_ar_backoffice_fe_deploy"></a> [emd\_ar\_backoffice\_fe\_deploy](#module\_emd\_ar\_backoffice\_fe\_deploy) | ./.terraform/modules/__devops_v0__/azuredevops_build_definition_generic | n/a |
...
| <a name="input_emd_ar_backoffice_admin_fe"></a> [emd\_ar\_backoffice\_admin\_fe](#input\_emd\_ar\_backoffice\_admin\_fe) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "path": "mdc\\emd-ar-backoffice-admin-fe"<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "emd-ar-backoffice-admin-fe",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops"<br/>  }<br/>}</pre> | no |
| <a name="input_emd_ar_backoffice_fe"></a> [emd\_ar\_backoffice\_fe](#input\_emd\_ar\_backoffice\_fe) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "path": "mdc\\emd-ar-backoffice-fe"<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "emd-ar-backoffice-fe",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops"<br/>  }<br/>}</pre> | no |
