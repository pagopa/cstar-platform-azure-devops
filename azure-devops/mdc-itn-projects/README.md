...
| <a name="input_mdc_aks_deploy"></a> [mdc\_aks\_deploy](#input\_mdc\_aks\_deploy) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "name": "mdc-aks-deploy",<br/>    "path": "argocd"<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/argocd-init",<br/>    "name": "mil-aks-deploy",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops"<br/>  }<br/>}</pre> | no |
