locals {
  ...
  idpay-fe-common-variables_deploy = {
    ...
    dev_azure_subscription = azuredevops_serviceendpoint_azurerm.DEV-CSTAR.service_endpoint_name
    ...
    uat_azure_subscription = azuredevops_serviceendpoint_azurerm.UAT-CSTAR.service_endpoint_name
    ...
    prod_azure_subscription = azuredevops_serviceendpoint_azurerm.PROD-CSTAR.service_endpoint_name
