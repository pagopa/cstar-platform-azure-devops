locals {
  ...
  idpay-fe-common-variables_deploy = {
    ...
    dev_react_app_url_fe_pre_login_merchants        = "https://api-io.dev.cstar.pagopa.it/idpay/merchants/token"
    ...
    dev_react_app_url_api_merchants                 = "https://api-io.dev.cstar.pagopa.it/idpay/merchants"
    ...
    uat_react_app_url_fe_pre_login_merchants        = "https://api-io.uat.cstar.pagopa.it/idpay/merchants/token"
    ...
    uat_react_app_url_api_merchants                 = "https://api-io.uat.cstar.pagopa.it/idpay/merchants"
    ...
    prod_react_app_url_fe_pre_login_merchants        = "https://api-io.cstar.pagopa.it/idpay/merchants/token"
    ...
    prod_react_app_url_api_merchants                 = "https://api-io.cstar.pagopa.it/idpay/merchants"
