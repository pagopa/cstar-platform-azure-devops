...
module "DEV-CSTAR-IDPAY-TLS-CERT-SERVICE-CONN" {
  ...
  source     = "git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_azurerm_limited?ref=v5.0.0"
...
module "DEV-CSTAR-IDPAY-TLS-CERT-SERVICE-CONN-NEW" {
  ...
  depends_on = [data.azuredevops_project.project]
  source     = "git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated?ref=v5.1.1"
...
module "UAT-CSTAR-IDPAY-TLS-CERT-SERVICE-CONN-NEW" {
...
module "PROD-CSTAR-IDPAY-TLS-CERT-SERVICE-CONN-NEW" {
