locals {
  ...
  dns_zone_third  = "cittadini.pagopa.it"
  ...
  dev_domain_kv_resource_group = "${local.prefix}-d-${local.location_short}-cittadini-sec-rg"
  ...
  uat_domain_kv_resource_group = "${local.prefix}-u-${local.location_short}-cittadini-sec-rg"
  ...
  prod_domain_kv_resource_group = "${local.prefix}-p-${local.location_short}-cittadini-sec-rg"
