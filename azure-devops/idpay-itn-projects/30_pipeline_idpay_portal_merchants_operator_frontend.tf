...
locals {
  ...
  idpay_portal_merchants_operator_frontend_variables_deploy = {
    ...
    DEV_CDN_ENDPOINT                                          = local.dev_welfare_cdn_endpoint #todo
    DEV_CDN_PROFILE                                           = local.dev_welfare_cdn_profile #todo
    DEV_RESOURCE_GROUP                                        = local.dev_welfare_storage_account_rg #todo
    DEV_STORAGE_ACCOUNT                                       = local.dev_welfare_storage_account_name #todo
    DEV_REACT_APP_URL_CDN                                     = local.dev_react_app_url_cdn #todo
    # DEV_REACT_APP_URL_FE_PRE_LOGIN_MERCHANTS                  = local.dev_react_app_url_fe_pre_login_merchants
    DEV_REACT_APP_URL_FE_LOGIN                                = local.dev_react_app_url_fe_login #todo
    DEV_REACT_APP_URL_FE_LANDING                              = local.dev_react_app_url_fe_landing #todo
    ...
    DEV_REACT_APP_URL_STORAGE                                 = local.dev_react_app_url_storage #todo
    ...
    DEV_REACT_APP_URL_KEYCLOAK                                = local.dev_react_app_url_keycloak
    DEV_REACT_APP_KEYCLOAK_REALM                              = local.dev_react_app_keycloak_realm
    DEV_REACT_APP_KEYCLOAK_CLIENT_ID                          = local.dev_react_app_keycloak_client_id
    ...
    UAT_REACT_APP_URL_KEYCLOAK                                  = local.uat_react_app_url_keycloak
    UAT_REACT_APP_KEYCLOAK_REALM                                = local.uat_react_app_keycloak_realm
    UAT_REACT_APP_KEYCLOAK_CLIENT_ID                            = local.uat_react_app_keycloak_client_id
  ...
  PROD_REACT_APP_URL_KEYCLOAK                                  = local.prod_react_app_url_keycloak
  PROD_REACT_APP_KEYCLOAK_REALM                                = local.prod_react_app_keycloak_realm
  PROD_REACT_APP_KEYCLOAK_CLIENT_ID                            = local.prod_react_app_keycloak_client_id
