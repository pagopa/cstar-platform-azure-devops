...
locals {
  ...
  idpay_portal_merchants_operator_frontend_variables_deploy = {
    ...
    DEV_VITE_APP_URL_KEYCLOAK       = local.dev_react_app_url_keycloak
    DEV_VITE_APP_KEYCLOAK_REALM     = local.dev_react_app_keycloak_realm
    DEV_VITE_APP_KEYCLOAK_CLIENT_ID = local.dev_react_app_keycloak_client_id
    ...
    UAT_VITE_APP_URL_KEYCLOAK       = local.uat_react_app_url_keycloak
    UAT_VITE_APP_KEYCLOAK_REALM     = local.uat_react_app_keycloak_realm
    UAT_VITE_APP_KEYCLOAK_CLIENT_ID = local.uat_react_app_keycloak_client_id
    ...
    PROD_VITE_APP_URL_KEYCLOAK       = local.prod_react_app_url_keycloak
    PROD_VITE_APP_KEYCLOAK_REALM     = local.prod_react_app_keycloak_realm
    PROD_VITE_APP_KEYCLOAK_CLIENT_ID = local.prod_react_app_keycloak_client_id
