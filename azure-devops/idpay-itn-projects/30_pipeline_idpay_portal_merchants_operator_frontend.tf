...
locals {
  ...
  idpay_portal_merchants_operator_frontend_variables_deploy = {
    ...
    DEV_VITE_URL_APP_KEYCLOAK       = local.dev_vite_keycloak_url
    DEV_VITE_APP_KEYCLOAK_REALM     = local.dev_vite_keycloak_realm
    DEV_VITE_APP_KEYCLOAK_CLIENT_ID = local.dev_vite_keycloak_client_id
    ...
    UAT_VITE_URL_APP_KEYCLOAK       = local.uat_vite_keycloak_url
    UAT_VITE_APP_KEYCLOAK_REALM     = local.uat_vite_keycloak_realm
    UAT_VITE_APP_KEYCLOAK_CLIENT_ID = local.uat_vite_keycloak_client_id
    ...
    PROD_VITE_URL_APP_KEYCLOAK       = local.prod_vite_keycloak_url
    PROD_VITE_APP_KEYCLOAK_REALM     = local.prod_vite_keycloak_realm
    PROD_VITE_APP_KEYCLOAK_CLIENT_ID = local.prod_vite_keycloak_client_id
