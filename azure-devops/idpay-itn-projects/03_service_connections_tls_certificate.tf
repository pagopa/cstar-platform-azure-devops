...
module "dev_tls_cert_service_connection" {
  ...
  identity_name                = "${local.product}-dev-${local.domain}-azdo-tls-cert"
...
module "uat_tls_cert_service_connection" {
  ...
  identity_name                = "${local.product}-uat-${local.domain}-azdo-tls-cert"
...
module "prod_tls_cert_service_connection" {
  ...
  identity_name                = "${local.product}-prod-${local.domain}-azdo-tls-cert"
