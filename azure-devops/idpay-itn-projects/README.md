...
| <a name="module_federated_cert_pipeline_bonus_dev"></a> [federated\_cert\_pipeline\_bonus\_dev](#module\_federated\_cert\_pipeline\_bonus\_dev) | ./.terraform/modules/__devops_v0__/azuredevops_build_definition_tls_cert_federated | n/a |
| <a name="module_federated_cert_pipeline_bonus_prod"></a> [federated\_cert\_pipeline\_bonus\_prod](#module\_federated\_cert\_pipeline\_bonus\_prod) | ./.terraform/modules/__devops_v0__/azuredevops_build_definition_tls_cert_federated | n/a |
| <a name="module_federated_cert_pipeline_bonus_uat"></a> [federated\_cert\_pipeline\_bonus\_uat](#module\_federated\_cert\_pipeline\_bonus\_uat) | ./.terraform/modules/__devops_v0__/azuredevops_build_definition_tls_cert_federated | n/a |
...
| <a name="module_idpay-fe-users_deploy"></a> [idpay-fe-users\_deploy](#module\_idpay-fe-users\_deploy) | ./.terraform/modules/__devops_v0__/azuredevops_build_definition_generic | n/a |
...
| <a name="input_idpay-portal-users-frontend"></a> [idpay-portal-users-frontend](#input\_idpay-portal-users-frontend) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "path": "idpay\\idpay-portal-users-frontend"<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/main",<br>    "name": "idpay-portal-users-frontend",<br>    "organization": "pagopa",<br>    "path": "idpay\\frontend",<br>    "pipelines_path": ".devops",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
