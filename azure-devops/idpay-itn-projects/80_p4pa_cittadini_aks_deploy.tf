...
#     repository = {
#       organization   = "pagopa"
#       name           = "arc-idpay-deploy-aks"
#       branch_name    = "refs/heads/main"
#       pipelines_path = ".devops"
#     }
#     pipeline = {
#       path = "argocd\\arc-idpay-deploy-aks"
#       name = "arc-idpay-deploy-aks"
#     }
#   }
# }
...
#     DEV_ARGOCD_PASSWORD               = module.idpay_dev_secrets.values["argocd-admin-password"].value
...
#     #     UAT_ARGOCD_SERVER                 = module.idpay_uat_secrets.values["argocd-server-url"].value
#     #     UAT_ARGOCD_USERNAME               = module.idpay_uat_secrets.values["argocd-admin-username"].value
#     #     UAT_ARGOCD_PASSWORD               = module.idpay_uat_secrets.values["argocd-admin-password"].value
...
#     #     PROD_ARGOCD_SERVER                 = module.idpay_prod_secrets.values["argocd-server-url"].value
#     #     PROD_ARGOCD_USERNAME               = module.idpay_prod_secrets.values["argocd-admin-username"].value
#     #     PROD_ARGOCD_PASSWORD               = module.idpay_prod_secrets.values["argocd-admin-password"].value
