locals {
  ...
  certificates = {
    # shared.itn.internl.cstar.pagopa.it
    shared-itn-internal-dev-cstar-pagopa-it : {
      env              = "dev"
      dns_record_name  = "shared.itn.internal"
      variables        = {}
      variables_secret = {}
    }
    shared-itn-internal-uat-cstar-pagopa-it : {
      env              = "uat"
      dns_record_name  = "shared.itn.internal"
      variables        = {}
      variables_secret = {}
    }
    shared-itn-internal-cstar-pagopa-it : {
      env              = "prod"
      dns_record_name  = "shared.itn.internal"
      variables        = {}
      variables_secret = {}
