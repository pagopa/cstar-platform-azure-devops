...
module "management-cstar-uat-pagopa-it-cert_az" {
  ...
  name       = "${var.management-cstar-uat-pagopa-it.pipeline.dns_record_name}.${var.management-cstar-uat-pagopa-it.pipeline.dns_zone_name}"
  #tfsec:ignore:general-secrets-no-plaintext-exposure
  #tfsec:ignore:GEN003
  ...
  credential_subcription              = local.management-cstar-uat-pagopa-it.credential_subcription
