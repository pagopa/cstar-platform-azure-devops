...
resource "azuredevops_serviceendpoint_github" "io-azure-devops-github-rw" {
  ...
  auth_personal {
    personal_access_token = module.azdo_prod_secrets.values["cstar-azure-devops-github-rw-TOKEN"].value
  }
  lifecycle {
...
resource "azuredevops_serviceendpoint_github" "io-azure-devops-github-ro" {
  ...
  auth_personal {
    personal_access_token = module.azdo_prod_secrets.values["cstar-azure-devops-github-ro-TOKEN"].value
  }
  lifecycle {
    ignore_changes = [description, authorization]
  }
...
resource "azuredevops_serviceendpoint_github" "io-azure-devops-github-pr" {
  ...
  auth_personal {
    personal_access_token = module.azdo_prod_secrets.values["cstar-azure-devops-github-pr-TOKEN"].value
  }
  lifecycle {
    ignore_changes = [description, authorization]
  }
