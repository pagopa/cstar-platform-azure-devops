...
module "api-cstar-dev-pagopa-it-cert_az" {
  ...
  name       = "${var.api-cstar-dev-pagopa-it.pipeline.dns_record_name}.${var.api-cstar-dev-pagopa-it.pipeline.dns_zone_name}"
  #tfsec:ignore:general-secrets-no-plaintext-exposure
  #tfsec:ignore:GEN003
  ...
  dns_record_name         = var.api-cstar-dev-pagopa-it.pipeline.dns_record_name
  dns_zone_name           = var.api-cstar-dev-pagopa-it.pipeline.dns_zone_name
  dns_zone_resource_group = local.api-cstar-dev-pagopa-it.dns_zone_resource_group
  tenant_id               = local.api-cstar-dev-pagopa-it.tenant_id
  subscription_name       = local.api-cstar-dev-pagopa-it.subscription_name
  subscription_id         = local.api-cstar-dev-pagopa-it.subscription_id

  credential_subcription              = local.api-cstar-dev-pagopa-it.credential_subcription
  credential_key_vault_name           = local.api-cstar-dev-pagopa-it.credential_key_vault_name
  credential_key_vault_resource_group = local.api-cstar-dev-pagopa-it.credential_key_vault_resource_group
  ...
  service_connection_ids_authorization = local.api-cstar-dev-pagopa-it.service_connection_ids_authorization
