...
module "portal-cstar-dev-pagopa-it-cert_az" {
  ...
  name       = "${var.portal-cstar-dev-pagopa-it.pipeline.dns_record_name}.${var.portal-cstar-dev-pagopa-it.pipeline.dns_zone_name}"
  #tfsec:ignore:general-secrets-no-plaintext-exposure
  #tfsec:ignore:GEN003
  ...
  credential_subcription              = local.portal-cstar-dev-pagopa-it.credential_subcription
